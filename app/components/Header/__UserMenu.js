...
/*-------------------------------------- USER DATA -------------------------------------*/
  ...
  const [location, setLocation] = useState('Darhan, MN');
             ...
             {/* NAME */}
              <Grid container alignItems='center' marginBottom={1}>
                ...
                <Grid item xs={10} textAlign='left'>
                   <Typography color="#9f5a47" fontSize= "3vh" fontFamily='EB Garamond Variable' fontWeight='bold' marginLeft={2}> {name}</Typography>
                   <Typography color="#9f5a47" fontSize= "2vh" fontFamily='EB Garamond Variable' marginLeft={2} marginTop={-1}> {email}</Typography>
                </Grid> 
              </Grid>
              ...
              <Grid container alignItems='center'>
                ...
                <Grid item xs={10} textAlign='left'>
                   <Typography color="#9f5a47" fontSize= "3vh" fontFamily='EB Garamond Variable' marginLeft={2}> {location}</Typography>
                </Grid> 
              </Grid>
              ...
              <Grid container alignItems='center'>
                ...
                <Grid item xs={10} textAlign='left'>
                   <Typography color="#9f5a47" fontSize= "3vh" fontFamily='EB Garamond Variable' fontWeight='bold' marginLeft={2}> {code}</Typography>
                </Grid> 
              </Grid>   
