...
import { getComparator, stableSort, useStyles, EnhancedTableHead} from "./OpListFunctions"
...
const TT = [
    {
    "label": "T2-1 HERDER GABRI",
    "tierCod": "T2-1",
    "nameOriginal": "T2-1 HERDER GABRI",
    "nameReference": "HERDER GABRI T2-1",
    "tierLevelCod": "2",
    "active": "1",
    "site": [
    {
  ...
  const TS = [
    ...
    {
    "index": 1,
    "GPSLongitude": "2.2.2.2.2",
    "GPSLatitude": "1.1.1.1.1"
    },
    {
    "index": 2,
    "GPSLongitude": "2.2.2.2.2",
    "GPSLatitude": "1.1.1.1.2"
    },
    {
    "index": 3,
    "GPSLongitude": "2.2.2.2.4",
    "GPSLatitude": "1.1.1.1.2"
    },
    {
    "index": 4,
    "GPSLongitude": "2.2.2.2.5",
    "GPSLatitude": "1.1.1.1.2"
    }
    ]
  }
        ...
        {/* 1° Input Filter : Herder Community*/}
            <Grid container alignItems='center'>
              ...
              <Autocomplete
                ...
                options={TT}
                // sx={{''}}
                renderInput={(params) => <TextField {...params} label="Herder Community" />}
              />             
              </Grid> 
        ...
        <Tabs className={classes.tabs}
          ...
          //  centered
            >
              ...
              <Tab label= "ASSIGNED"/>
              <Tab label= "ACCEPTED" style={{marginLeft: '1rem', marginRight: '1rem'}}/>
              <Tab label= "COLLECTED"/>
          </Tabs>  
          ...
          <Paper>
            <Grid container alignItems='center'>
                <Grid item xs={6}>
                  <Grid item height={80} sx={{backgroundColor: '#9f5a47', border: 2, borderColor: '#f6f2e0'}} mt={2} ml={2} mr={1} mb={1}>
                    <Typography ml={2} mt={.2} color='#f6f2e0' sx={{fontSize: '90%'}}>Recieved Bales</Typography>
                    <Typography ml={2} mt={-1} color='#f6f2e0' sx={{fontSize: '250%'}}>145</Typography>
                  </Grid>
                </Grid>
                <Grid item xs={6}>
                  <Grid item height={80} sx={{backgroundColor: '#9f5a47', border: 2, borderColor: '#f6f2e0'}} mt={2} mr={2} ml={1} mb={1}>
                    <Typography ml={2} mt={.2} color='#f6f2e0' sx={{fontSize: '90%'}}>Collected Bales</Typography>
                    <Typography ml={2} mt={-1} color='#f6f2e0' sx={{fontSize: '250%'}}>145</Typography>
                  </Grid>
                </Grid>
              </Grid>
              ...
              <Grid container>
                <Grid item xs={6}>
                  <Grid item height={80} sx={{backgroundColor: '#9f5a47', border: 2, borderColor: '#f6f2e0'}} mt={1} ml={2} mr={1} mb={1}>
                    <Typography ml={2} mt={.2} color='#f6f2e0' sx={{fontSize: '90%'}}>Assigned Bales</Typography>
                    <Typography ml={2} mt={-1} color='#f6f2e0' sx={{fontSize: '250%'}}>145</Typography>
                  </Grid>
                </Grid>
                <Grid item xs={6}>
              ...
              <Grid container>
                <Grid item xs={6}>
                  <Grid item height={80} sx={{backgroundColor: '#1c7e76', border: 2, borderColor: '#f6f2e0'}} mt={1} ml={2} mr={1} mb={2}>
                    <Typography ml={2} mt={.2} color='#f6f2e0' sx={{fontSize: '90%'}}>Not Assigned</Typography>
                    <Typography ml={2} mt={-1} color='#f6f2e0' sx={{fontSize: '250%'}}>145</Typography>
                  </Grid>
                </Grid>
                <Grid item xs={6}>
                  <Grid item height={80} sx={{backgroundColor: '#9f5a47', border: 2, borderColor: '#f6f2e0'}} mt={1} mr={2} ml={1} mb={2}>
                    <Typography ml={2} mt={.2} color='#f6f2e0' sx={{fontSize: '90%'}}>Processing</Typography>
                    <Typography ml={2} mt={-1} color='#f6f2e0' sx={{fontSize: '250%'}}>145</Typography>
                  </Grid>
                </Grid>
              </Grid>
                      ...
                      .map((row, index) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <TableCell align="left" size='small' style={{fontSize: '16px'}}>{row.tierCode}</TableCell>
                            <TableCell align="left" size='small' style={{fontSize: '16px'}}>{row.date}</TableCell>
                            <TableCell align="center" size='small' style={{fontSize: '16px'}}><FindInPageIcon style={{color: '#494a4c', marginRight: '1rem'}}/> 
                                {row.statusCode === '0' ? <PauseIcon style={{color: '#494a4c'}}/> : (row.statusCode === '1' ? <StopIcon style={{color: '#9f5a47'}}/> : <SyncIcon style={{color: '#1c7e76'}}/>) }
                            </TableCell>
