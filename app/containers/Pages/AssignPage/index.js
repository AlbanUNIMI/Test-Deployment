    ...
    <div>
      ...
      <Grid container height='70vh' alignItems="center">
         <Grid xs={12} item textAlign="center">
           <Button variant="outlined" style={{ color: '#f6f2e0', borderColor: '#f6f2e0', borderRadius: 5}} onClick={()=> handleJob()}><img src={ad} height='10rem' style={{marginRight: '.5rem'}}/><strong>Start new assignment</strong></Button>
         </Grid>
      </Grid>
     ...
     {currentJob && ( // Work / Resume current JOB
      ...
      <Grid container alignItems="left">
        <Grid xs={12} item textAlign="left">
          ...
          >
            Empty Sack Assignment{" "}
            <img src={ad} height="15" style={{ marginTop: "-0.2rem" }} />
          </Typography>
        </Grid>
